        ...
        <>
            ...
            {open && (
                <div className="fixed inset-0 z-50 flex items-end lg:items-center justify-center bg-black/50">
                    ...
                    <div className="w-full lg:max-w-2xl bg-white rounded-t-lg lg:rounded-lg shadow-lg flex flex-col max-h-[90vh]">
                        ...
                        <div className='p-5 flex flex-col gap-5'>
                            ...
                            <div className='flex justify-between lg:justify-normal gap-5'>
                                <button className='lg:w-full px-4 lg:px-0 lg py-2 lg:py-3 border-2 border-red-500 text-red-500'>
                                    Decline
                                </button>
